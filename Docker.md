...
* [Docker 101 Introduction to Docker](https://www.youtube.com/watch?v=z_ace9c97PE)
...
* [Docker Containers on IBM Bluemix](https://www.youtube.com/watch?v=fFdzJkVY5fc)
* [Continuous Delivery with Jenkins Workflow and Docker Explained](https://www.youtube.com/watch?v=vQSpztWcGmw)
* [Continuous Delivery Pipeline with Docker and Jenkins](https://www.youtube.com/watch?v=uLp9_MMnkUo)
* [Deploy your first application](https://www.youtube.com/watch?v=dmW0Xi4D3WU)
* [Sylvain Bellemare: Learning to use Docker for development](https://www.youtube.com/watch?v=OrPoChOSUSE)
* [Manage Docker Containers with Puppet | how it work together](https://www.youtube.com/watch?v=cAxizAk7l8s)
* [Tor + Docker = Anonymous](https://www.youtube.com/watch?v=4u8egQ7rvMk)
* [Using Docker to Develop, Test and Run Maven Projects](https://www.youtube.com/watch?v=xNi2oQ25wA4)
* [Hosting a custom web portal for SoftLayer on Bluemix using Docker](https://www.youtube.com/watch?v=zaWNOyP_WcM)
* [Continuous Delivery as Code with Jenkins Workflow](https://www.youtube.com/watch?v=Q2pZdzaaCXg)
